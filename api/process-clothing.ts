...
- rotation_needed: the CLOCKWISE rotation in degrees (0, 90, 180, or 270) needed to make the clothing item appear in its CORRECT upright orientation. The correct orientation means: for tops/shirts/outerwear the collar/neckline is at the top; for bottoms/pants the waistband is at the top; for footwear/shoes the opening is at the top and sole at the bottom; for dresses the neckline is at the top. If the item is ALREADY upright, use 0. If the item appears sideways (rotated 90° clockwise), use 270 to correct it. If upside down, use 180. IMPORTANT: carefully check if the image needs rotation.
...
Output: One clean product photo of the COMPLETE item (including BOTH shoes for footwear) on a white background in CORRECT upright orientation. NO person or mannequin body visible.`;
