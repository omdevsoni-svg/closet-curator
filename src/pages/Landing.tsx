    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative pt-24 pb-14 sm:pt-32 sm:pb-20 md:pt-44 md:pb-32">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -right-32 top-40 h-[250px] w-[250px] sm:h-[400px] sm:w-[400px] rounded-full bg-[hsl(350,80%,58%)]/10 blur-[100px]" />
        </div>
            ...
            {[
              ...
              >
                ...
                <div className="mt-5 flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-accent to-[hsl(350,80%,58%)] text-sm font-display font-bold text-white">
                    {testimonial.name[0]}
                  </div>
                  <div>
      ...
      <section className="py-14 sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-5">
          <motion.div
            {...fadeUp}
            className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[hsl(38,90%,50%)] to-[hsl(350,80%,58%)] p-7 text-center sm:p-10 md:p-16"
          >
