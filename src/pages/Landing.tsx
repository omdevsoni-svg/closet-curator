          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="flex flex-col gap-1 px-4 py-3">
                <a href="#features" onClick={() => setMobileMenuOpen(false)} className="rounded-xl px-3 py-2.5 text-sm font-body font-medium text-muted-foreground transition-colors        >
              <div className="flex flex-col gap-1 px-4 py-3">
